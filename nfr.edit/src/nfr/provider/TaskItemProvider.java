...
/**
 * This is the item provider adapter for a {@link nfr.Task} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TaskItemProvider extends GraphcialObjectItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Task_sourceRef_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Task_sourceRef_feature", "_UI_Task_type"),
				 NfrPackage.Literals.TASK__SOURCE_REF,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTargetRefPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Task_targetRef_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Task_targetRef_feature", "_UI_Task_type"),
				 NfrPackage.Literals.TASK__TARGET_REF,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(NfrPackage.Literals.TASK__SEQUENCE_TO_TARGET);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(NfrPackage.Literals.TASK__SEQUENCE_TO_TARGET,
